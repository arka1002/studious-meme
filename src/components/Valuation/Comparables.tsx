        ...
        <>
            <div className="bg-white p-7 shadow-md">
                <div className="flex justify-end py-2">
                    <select id="series" className="w-[150px] bg-[#F3F3FF] text-sm font-semibold text-[#1FC39E] px-2 py-2 rounded">
                        <option value="revenue">use EV/Revenue </option>
                        <option value="ebita">use EV/EBITA </option>
